        ...
        <div style={{
          ...
          <form onSubmit={handleFdaSearch} style={{ display: 'flex', gap: '12px', marginBottom: '24px' }}>
            <input
              ...
              placeholder="พิมพ์เลขทะเบียน อย. หรือชื่อยา เช่น G762/47, 1A 1289/28 หรือ BENZAC, SARA (ค้นหาหลายรายการใช้เครื่องหมาย , )"
              style={{
                flex: 1,
          ...
          {/* Barcode & FDA Guide Cards (Shown only when NOT searched yet) */}
